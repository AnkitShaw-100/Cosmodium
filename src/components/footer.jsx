        ...
        <div className="max-w-7xl mx-auto px-6 py-10">
          ...
          <div className="flex flex-col md:flex-row md:justify-between gap-8">
            ...
            <div className="max-w-sm w-full">
              <h2 className="text-white font-semibold text-xl">Cosmodium</h2>
              <p className="mt-3 text-sm text-gray-400 leading-relaxed">
                A simple and fast URL shortener to create, manage, and track
              ...
              <div>
                ...
                <ul className="space-y-2 text-gray-400">
                  <li>
                    <a
                      href="#"
                      className="block hover:text-white hover:underline transition-colors duration-150 focus:outline-none focus-visible:ring-2 focus-visible:ring-white/10 rounded"
                    >
                      URL Shortening
                    </a>
                  </li>
